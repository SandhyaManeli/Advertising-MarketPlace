...
<div class="container">
		...
		<br/><br/><br/><br/>
			...
			<table>
				...
				<?php
				 ...
				 <table>
				<tr> 			 
					 <td class="border_1" style="color:#990100; border-right-style: hidden; padding-left:10px;"><b>Impressions Total -</b><b>  <?php echo $campaign_impressionSum; ?></b></td>
	...
	<!--<div style="margin-top:20px">
		...
		<div class="row">
				...
				<p class=""><b>Facing:</b> <?php echo $product['direction'] ;?></p>
				<p class=""><b>Latitude:</b> <?php echo $product['lat'] ;?></p>
				<p class=""><b>Longitude:</b> <?php echo $product['lng'] ;?></p>
				<p class=""><b>Notes:</b> <?php echo $product['notes']; ?></p>
				...
				<p class=""><b>Comments:</b> <?php echo $product['Comments']; ?></p>
				...
				<p class=""><?php if($product['looplength']!=''){ ?><b>Loop Length:</b> <?php echo $product['looplength'];  } ?></p>
