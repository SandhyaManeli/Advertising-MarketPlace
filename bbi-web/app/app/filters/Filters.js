...
app.filter('searchFilter', function($filter) {
  return function(dataAry, searchTextAry) {
    if (searchTextAry && searchTextAry.length) {
      console.log('searchTextAry', searchTextAry);
      let resultAry = [];
      searchTextAry.forEach((text) => {
        console.log('text: ', text);
        const filteredAry = $filter('filter')(dataAry,text);
        console.log('filteredAry: ', filteredAry);
        resultAry = [...resultAry, ...filteredAry];
