angular.module("bbManager").factory('OwnerLocationService', 
	['$http', '$q', 'config', 
		function($http, $q, config){
			return {
				...
				searchArea: function(query){
					var dfd = $q.defer();
					$http.get(config.apiPath + '/search-loc/' + query).success(dfd.resolve).error(dfd.reject);
					return dfd.promise;
				}
			}
		}
