...
class ProductsBulkUploads extends Command {
   ...
   * @var string
   */
  protected $name = 'ProductsBulkUploads:command';
   ...
   * @var string
   */
  protected $description = "Bulk upload csv cron";
    ...
    try{
        ...
        foreach ($get_json_files_data as $key => $value) {
            ...
            if (file_exists($json_file_name)) {
                ...
                $mail_tmpl_params = [
                    'receiver_name' => 'Pankaj',
                    'mail_message' => 'Bulk Upload For Type - '. $product_type . ' Execution Done Successfully <br> You can check data now.'           
                ];
                $mail_data = [
                    'email_to' => 'pankaj.mulchandani@peopletech.com',
                    'email_to1' => 'AMPDEVTEAM@peopletech.com',
                    //'email_to1' => 'admin@advertisingmarketplace.com', // CC of Email
                    'recipient_name' => 'Pankaj', 
                ...
                $mail_tmpl_params = [
                    'receiver_name' => 'Pankaj',
                    'mail_message' => 'Bulk Upload For Type - '. $product_type . ' Having Any Issue, Something Went Wrong. <br> Please re-check the CSV File & Re-Upload Again.'
                ];
                $mail_data = [
                    'email_to' => 'pankaj.mulchandani@peopletech.com',
                    'email_to1' => 'AMPDEVTEAM@peopletech.com',
                ...
                Mail::send('mail.bulk_upload_failure', $mail_tmpl_params, function($message) use ($mail_data) {
                    $message->to($mail_data['email_to'], $mail_data['recipient_name'])->subject('Bulk Upload CSV File Execution Failed');
